...
# class BaseTunerLayer:
    ...
    def enable_adapters(self, enabled: bool):
        r"""Toggle the enabling and disabling of adapters
    ...
    def set_adapter(self, adapter_names: str | list[str]):
        ...
        # 只把adapter_name的层的梯度计算打开，并将其放入self.active_adapters中，在前向时只有位于self.active_adapters中，才会参与运算
