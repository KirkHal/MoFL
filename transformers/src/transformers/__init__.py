...
try:
    ...
    _import_structure["models.llama"].extend(
        ["LlamaForCausalLM", "LlamaForSequenceClassification", "LlamaModel", "LlamaPreTrainedModel", "LlamaMoEV7ForCausalLM", "LlamaAttention"]
    )
...
if TYPE_CHECKING:
    ...
    try:
        ...
        from .models.llama import LlamaForCausalLM, LlamaForSequenceClassification, LlamaModel, LlamaPreTrainedModel, LlamaMoEV7ForCausalLM, LlamaAttention
